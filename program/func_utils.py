...
def get_ISO_times():
    # Get timestamps
    date_start_0 = datetime.now()  # Get date right now

    # What the start time will be 100 hours before that time above, because we are running the strategy on hourly data
    # 400 hours of data, 16.6667 Days of data
    # 500 hours of data, 20.8 Days of data
